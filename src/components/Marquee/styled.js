...
export const MarqueeContainerStyled = styled.div(
  props => css`
    position: relative;
    left: 0;
    top: 0;
...
export const MarqueeItemStyled = styled.div(
  props => css`
    position: relative;
    z-index: 0;
    flex-shrink: 0;
...
export const MarqueeItemInnerStyled = styled.div(
  props => css`
    background: ${rgba(props.theme.colorBackgroundDefault, 0.97)};
  `,
);
